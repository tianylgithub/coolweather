...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(final String weatherId) {
        ...
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=a3cfeb60b38c46589c52f70645609164";
...
//            }
    ...
    {
        Toast.makeText(WeatherActivity.this, "获取天气信息失败s", Toast.LENGTH_SHORT).show();
    }
    }
}
